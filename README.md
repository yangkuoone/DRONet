...
#### 4.1.2 Running
```
nohup python -u main.py --method DeepWalk --input '../../mydata/data2/graph+dis+drug.edgelist' --output '../../result/DeepWalk/graph+dis+drug_100_embeddings.txt' > DeepWalk.txt 2>&1 &
```
...
#### 4.2.3 Running
```
nohup python -u main.py --method LambdaRank --input_train './mydata/data2/train_1v5.txt' --input_test './mydata/data2/test_1v5.txt' --output './resultdata/LambRank/example_LambRank_1v5.txt'> test_res.txt 2>&1 &
```
